...
def build_argument_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "world",
        nargs="?",
        help="path to the generated .world file"
    )
    parser.add_argument(
        "--input-world",
        dest="input_world",
...
def main(argv: Optional[Sequence[str]] = None) -> None:
    ...
    world_path = args.input_world or args.world
    if not world_path:
        parser.error("provide --input-world or positional world path")
    ...
    model_paths = list(args.model_path)

    if default_rocks_path.exists():
        model_paths.append(str(default_rocks_path))

    if default_marsyard_models.exists():
        model_paths.append(str(default_marsyard_models))

    print("[heightmap] Runtime model paths:")
