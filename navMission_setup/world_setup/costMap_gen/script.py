...
def build_argument_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "heightmap",
        nargs="?",
        help="input height-map .npz"
    )
    parser.add_argument(
        "--input-heightmap",
        dest="input_heightmap",
        help="input height-map .npz"
    )
...
def main(argv: Optional[Sequence[str]] = None) -> None:
    ...
    heightmap_path = args.input_heightmap or args.heightmap
    if not heightmap_path:
        parser.error("provide --input-heightmap or positional heightmap path")
