...
def fuse_obstacle_data_into_world(
    ...
    for i, item in enumerate(obs_data, 1):
        ...
        v_uri_el.text = f"model://rock_{rock_id}/meshes/rock_{rock_id}.obj"
        ...
        if is_collidable:
            ...
            c_uri_el.text = f"model://rock_{rock_id}/meshes/rock_{rock_id}.obj"
...
def parse_args():
    ...
    parser.add_argument("-i", "--input", "--input-data", dest="input", type=str, default=None,
                        help="Input obstacle_data.npy path (default: obs_data/obstacle_data.npy in package src)")
    parser.add_argument("-w", "--world-name", "--base-world", dest="world_name", type=str, default="marsyard.world",
                        help="Base world file name from worlds package (default: marsyard.world)")
    parser.add_argument("-o", "--output", "--output-world", dest="output", type=str, default=None,
