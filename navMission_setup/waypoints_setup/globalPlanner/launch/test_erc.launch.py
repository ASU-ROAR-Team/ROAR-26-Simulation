"""Launch file for Phase 5: ERC Full Simulation testing."""
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('goal_x',   default_value='19.0'),
        DeclareLaunchArgument('goal_y',   default_value='19.0'),
        ...
        Node(
            package='dstar_navigation',
            executable='test_harness_erc.py',
            name='test_harness_erc',
            parameters=[{
                'start_x': start_x_cfg,
                'start_y': start_y_cfg,
                'goal_x': goal_x_cfg,
