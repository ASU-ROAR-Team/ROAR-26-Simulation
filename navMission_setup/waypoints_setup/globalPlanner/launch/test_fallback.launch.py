"""Launch file for Near-Goal Fallback testing."""
...
def generate_launch_description():
    ...
    declare_scenario = DeclareLaunchArgument('scenario', default_value='lidar_unreachable_goal', description='Dynamic scenario')
    ...
    # Node: Fallback Test Harness
    harness_node = Node(
        package='dstar_navigation',
        executable='test_harness_fallback.py',
        name='test_harness_fallback',
        parameters=[{
            'start_x': start_x_cfg,
            'start_y': start_y_cfg,
            'goal_x': goal_x_cfg,
