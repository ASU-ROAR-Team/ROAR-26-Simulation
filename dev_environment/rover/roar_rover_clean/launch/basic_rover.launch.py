...
def generate_launch_description():
    ...
    default_world = os.path.join(pkg_roar_rover_clean, 'worlds', 'rover_world.sdf')
    ...
    xacro_file = os.path.join(
        pkg_roar_rover_clean, 'urdf', 'base', 'rover_simulation.urdf.xacro')
    ...
    rviz_config_file = os.path.join(pkg_roar_rover_clean, 'rviz', 'basic_rover.rviz')
