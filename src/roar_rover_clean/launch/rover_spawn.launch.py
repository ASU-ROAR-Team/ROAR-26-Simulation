...
def generate_launch_description():
    ...
    pkg_share = os.path.join(os.path.expanduser('~'), 'roar_workspace', 'install', 'roar_rover_clean', 'share')
    ...
    urdf_file = PathJoinSubstitution([pkg_roar_rover_clean, 'urdf', 'base', 'rover_simulation.urdf.xacro'])
