...
> - **Workspace 2** → ROAR rover simulation (`roar_simulation`)
>
...
git clone -b Rover_Arm_Marsyard_Simualtion \
  https://github.com/ASU-ROAR-Team/ROAR-26-Simulation.git roar_simulation
...
| Arm missing in Gazebo | Rebuild: `colcon build --packages-select roar_simulation` |
| `package://roar_simulation` not found | Source `~/roar_ws/install/setup.bash` |
