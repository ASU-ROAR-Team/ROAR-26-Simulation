...
def generate_launch_description():
    ...
    # ── 2. Resource paths ─────────────────────────────────────────────────────
    install_dir      = os.path.abspath(os.path.join(pkg_roar_simulation, '..'))
    ...
    xacro_file = os.path.join(
        pkg_roar_simulation, 'urdf', 'base', 'rover_simulation_clean.urdf.xacro')
    ...
    world_file = os.path.join(
        pkg_roar_simulation, 'urdf', 'worlds', 'rover_world.sdf')
    ...
    rviz_config_file = os.path.join(pkg_roar_simulation, 'rviz', 'basic_rover.rviz')
