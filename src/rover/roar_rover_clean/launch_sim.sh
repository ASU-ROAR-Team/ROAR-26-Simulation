#!/usr/bin/env bash
# =============================================================================
# launch_sim.sh - Clean launch script for roar_rover_clean
...
echo "[launch_sim] Launching roar_rover_clean simulation..."
exec ros2 launch roar_rover_clean basic_rover.launch.py start_rviz:=$START_RVIZ
