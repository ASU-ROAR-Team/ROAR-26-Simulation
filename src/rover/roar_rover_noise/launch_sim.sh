#!/usr/bin/env bash
# =============================================================================
# launch_sim.sh - Clean launch script for roar_rover_noise
...
echo "[launch_sim] Launching roar_rover_noise simulation..."
exec ros2 launch roar_rover_noise basic_rover.launch.py start_rviz:=$START_RVIZ
